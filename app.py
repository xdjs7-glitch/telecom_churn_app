...
with col2:
    st.markdown(
        ...
        <div style="color: white; font-size: 16px; padding-top: 50px;">
            ...
            <p>Based on the collected dataset, <strong>85.5%</strong> (<strong>2,850</strong>) of customers did not churn,</p>
            <p>while <strong>14.5%</strong> (<strong>483</strong>) churned.</p>
        </div>
        """,
        unsafe_allow_html=True
    )
